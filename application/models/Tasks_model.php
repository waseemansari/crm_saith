...
class Tasks_model extends App_Model
{
    ...
    public function add($data, $clientRequest = false)
    {
        ...
        if ($insert_id) {
            ...
            log_activity('New Task Added [ID:' . $insert_id . ', Name: ' . $taskData['name'] . ']');
            hooks()->do_action('after_add_task', $insert_id);
    ...
    public function edit_inventory_item($data,$id='')
    {
    ...
    public function add_inventory_item($data)
    {
        ...
        if (!empty($data['items'])) {
            foreach ($data['items'] as $itemId => $item) {
                ...
                $inserted[] = [
                    'id'         => $insertId,
                    'item_name'  => get_item_description($item['id']), // your helper
                    'qty'        => $item['qty'],
                    'unit'       => $item['unit'],
                    'task_id'    => $item['task_id'],
                ];
