...
?>
    ...
    echo '<div class="media-body valign-middle">';
    echo '<div class="mtop5 tw-text-neutral-600">';
    echo '<b>';
    echo $comment['staffid'] != 0 ? e(get_staff_full_name($comment['staffid'])) : _l('is_customer_indicator');
    echo '</b> - <small class="mtop10 text-muted">' . e(time_ago($comment['dateadded'])) . '</small>';
    echo '</div>';

    echo '<div class="tw-text-neutral-500">';
    echo process_text_content_for_display($comment['content']);
    echo '</div>';
